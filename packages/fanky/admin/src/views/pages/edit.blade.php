...
<form action="{{ route('admin.pages.save') }}" onsubmit="return pageSave(this, event)">
	...
	<div class="nav-tabs-custom">
		<ul class="nav nav-tabs">
			...
			@if($page->id === 6)
				<li><a href="#tab_1a" data-toggle="tab">Текст</a></li>
			@endif
...
{{--                {!! Form::groupRichtext('text', $page->text, 'Текст') !!}--}}
				...
				{!! Form::groupCheckbox('on_menu', 1, $page->on_menu, 'Показывать в верхнем меню шапки сайта') !!}
				{!! Form::groupCheckbox('on_menu_bottom', 1, $page->on_menu_bottom, 'Показывать в нижнем меню шапки сайта') !!}
